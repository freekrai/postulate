var PARENT_DIRNAME, PARSER_SCHEMA, YAML_EXT, basename, co, dirname, dump, extname, isAbsolute, load, normalizeOptions, normalizePath, normalizePathSync, parse, read, readFile, readFileSync, readPromise, readSync, readdir, readdirSync, ref, ref1, ref2, ref3, sep, write, writeFile, writeFileSync, writePromise, writeSync, yaml,
...
ref2 = require('path'), dirname = ref2.dirname, basename = ref2.basename, extname = ref2.extname, sep = ref2.sep, isAbsolute = ref2.isAbsolute;
